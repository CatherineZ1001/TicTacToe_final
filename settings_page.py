...
def settings_page(screen):
    ...
    normal_modes_button = pygame.Rect(screen_center_x - button_width // 2, initial_y, button_width, button_height)
    special_modes_button = pygame.Rect(screen_center_x - button_width // 2, initial_y + button_height + button_space, 
                                       button_width, button_height)
    music_button = pygame.Rect(screen_center_x - button_width // 2, initial_y + 2*(button_height + button_space),
                              button_width, button_height)
    back_button = pygame.Rect(screen_center_x - button_width // 2, initial_y + 3*(button_height + button_space),
                               button_width, button_height)
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if normal_modes_button.collidepoint(event.pos):
                    normal_modes_page(screen)
                elif special_modes_button.collidepoint(event.pos):
...
def normal_modes_page(screen):
    ...
    button_width = 300 # Consistent width for all buttons
